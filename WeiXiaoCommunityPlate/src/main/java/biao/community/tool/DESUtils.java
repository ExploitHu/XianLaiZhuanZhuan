...
public class DESUtils {
    ...
    //sKey有效时间
    private static final float validTime = 5000;


    public static boolean checkSKey(String md5, String sKey){
        ...
        try{
            byte[] decryResult = DESUtils.decrypt(byteArray, md5);
